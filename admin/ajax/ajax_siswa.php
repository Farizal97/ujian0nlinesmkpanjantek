...
elseif($_GET['action'] == "form_data"){
   $query = mysqli_query($mysqli, "SELECT * FROM siswa WHERE id_siswa='$_GET[id]'");
...
elseif($_GET['action'] == "delete"){
   mysqli_query($mysqli, "DELETE FROM siswa WHERE id_siswa='$_GET[id]'");	
}
...
elseif($_GET['action'] == "reset"){
   ...
   $passArray	= explode("-",$tgl);
   $pass		= implode("",$passArray);
   mysqli_query($mysqli, "UPDATE siswa SET password = '$pass' WHERE id_siswa='$_GET[id]'");
   }
}
