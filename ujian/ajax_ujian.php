...
if($_GET['action']=="kirim_jawaban"){
   $rnilai = mysqli_fetch_array(mysqli_query($mysqli, "SELECT * FROM nilai WHERE id_ujian='$_POST[ujian]' AND nus='$_SESSION[nus]'"));
   ...
   mysqli_query($mysqli, "UPDATE nilai SET jawaban='$jawabanfix', sisa_waktu='$_POST[sisa_waktu]' WHERE id_ujian='$_POST[ujian]' AND nus='$_SESSION[nus]'");
...
elseif($_GET['action']=="selesai_ujian"){
   ...
   mysqli_query($mysqli, "UPDATE nilai SET jml_benar='$jbenar', nilai='$nilai' WHERE id_ujian='$_POST[ujian]' AND nus='$_SESSION[nus]'");
   
   mysqli_query($mysqli, "UPDATE siswa SET status='login' WHERE nus='$_SESSION[nus]'");
