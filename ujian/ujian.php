...
mysqli_query($mysqli, "UPDATE siswa SET status='mengerjakan' WHERE nus='$_SESSION[nus]'");
...
$qnilai = mysqli_query($mysqli, "SELECT * FROM nilai WHERE nus='$_SESSION[nus]' AND id_ujian='$_GET[ujian]'");
if(mysqli_num_rows($qnilai) < 1){
   mysqli_query($mysqli, "INSERT INTO nilai SET nus='$_SESSION[nus]', id_ujian='$_GET[ujian]', acak_soal='$acak_soal', jawaban='$jawaban', sisa_waktu='$rujian[lama_ujian]:00'");
}
