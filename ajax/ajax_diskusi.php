...
if($_GET['action'] == "table_data"){
	$query = mysqli_query($mysqli, "SELECT * FROM diskusi, siswa WHERE diskusi.id_user=siswa.nis AND diskusi.id_ujian='$_GET[ujian]' AND diskusi.id_kelas='$_GET[kelas]'");
...
elseif($_GET['action'] == "insert"){
   ...
   mysqli_query($mysqli, "INSERT INTO diskusi SET 
      ...
      id_kelas = '$_GET[kelas]',
      isi = '$pesan',
	  nama_user = '$_SESSION[namalengkap]',
	  id_user = '$_SESSION[nis]'");
   echo "ok";
}

//Mengedit data soal pada database tambahan id_ujian = '$_GET[ujian]',
