...
create_table(array("ID Guru","Nama Guru","Tempat Lahir","Tgl Lahir","Telepon","Jns Kelamin","Keterangan","Aksi"));

//Membuat form tambah dan edit user
open_form("modal_user", "return save_data()");
echo'<div class="form-group">
		<label for="id" class="col-sm-2 control-label">ID Guru</label>
		<div class="col-sm-4">
